...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'CoAuthMiddleware'=>[
            \App\Http\Middleware\CoAuthMiddleware::class,
        ],
        'WebAuthMiddleware'=>[
    ...
    protected $routeMiddleware = [
        'preventSubmitApplication' => \App\Http\Middleware\PreventSubmitApplication::class,
        'userloggedin' => \App\Http\Middleware\UserLoggedinMiddleware::class,

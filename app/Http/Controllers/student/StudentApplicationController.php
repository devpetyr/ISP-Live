...
class StudentApplicationController extends Controller
{
    ...
    {
        $data1 = SafStudentBasicInformationModel::where('user_id', auth()->id())->orderby('id', 'DESC')->first();
        $data2 = SafStudentInformationModel::where('user_id', auth()->id())->orderby('id', 'DESC')->first();
        $data3 = SafAgentInformationModel::where('user_id', auth()->id())->orderby('id', 'DESC')->first();
        $data4 = SafOtherInformationModel::where('user_id', auth()->id())->orderby('id', 'DESC')->first();
        $data5 = SafMedicalInformationModel::where('user_id', auth()->id())->orderby('id', 'DESC')->first();
        $data6 = SafAirportInformationModel::where('user_id', auth()->id())->orderby('id', 'DESC')->first();
        $data7 = SafPaymentInformationModel::where('user_id', auth()->id())->orderby('id', 'DESC')->first();
        $data8 = SafAgreementInformationModel::where('user_id', auth()->id())->orderby('id', 'DESC')->first();
        return view('student.application-form.new-application-form', compact('data1', 'data2', 'data3', 'data4', 'data5', 'data6', 'data7', 'data8'));
    }

    public function saf_section_status()
    {
...
//            return redirect()->route('web_home')->with('success', 'submitted successfully.');
        } else {

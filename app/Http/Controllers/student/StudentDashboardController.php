...
//    }
    ...
    public function new_application_form_submit(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            "if_yes_please_indicate_animal" => "required",
            ...
            "agent_wechat_number" => "required",
            "agent_line_number" => "required",
            "agent_whatsapp_number" => "required",
            ...
            "if_no_please_explain_health" => "required",
            "do_you_have_medical_allergies" => "required",
            "if_yes_please_explain_medical_allergies" => "required",
            "do_you_take_medication" => "required",
            "if_yes_please_explain_medication" => "required",
            "under_care_of_psychiatrist_past_five_year" => "required",
            "if_yes_please_explain_reason_of_psychiatrist" => "required",
...
//            'student_electronic_signature_date_2' => 'required',
        ...
        if ($user) {
            ...
            /** Agreement Form Details start*/
            $agreement_details = new AgreementDetailsStdAppFormModel();

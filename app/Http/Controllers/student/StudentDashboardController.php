...
////            $temper = explode("=" , $d);
////
////            array_push($temp[$temper[0]] , $temper[1]); //[[$temper[0]]]
////        }
////        dd( $temp, $request->all());
//
//        if ($request->section == 'Form-Section1') {
//
//            $request->validate([
//
...
//                "last_name" => "required",
//                "dob" => "required",
//                "age" => "required|numeric|min:1|digits_between:2,5",
//                "gender" => "required",
...
//                ]);
//        }elseif ($request->section == 'Form-Section2-1') {
//dd('1');
//            $request->validate([
//
//            ]);

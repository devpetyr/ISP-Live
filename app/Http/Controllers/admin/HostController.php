...
//    }
    ...
    public function host_application_detail_status(Request $request,$id)
    {
       $hostBasic=HafBasicInformationModel::where('id',$id)->first();
       $hostBasic->status=$request->application_status;
       $hostBasic->save();
     ...
     public function host_adult_application(Request $request,$id)
    {
        $request->validate([
            ...
            'adult1_first_name'=>'regex:/^[\pL\s\-]+$/u',
            'adult1_last_name'=>'regex:/^[\pL\s\-]+$/u',
            'adult1_work_phone'=>'regex:/^[\pL\s\-]+$/u',
            'adult1_relation'=>'regex:/^[\pL\s\-]+$/u',
            'adult1_occupation'=>'regex:/^[\pL\s\-]+$/u',
            'adult1_employer'=>'regex:/^[\pL\s\-]+$/u',
            'adult1_gender'=>'regex:/^[\pL\s\-]+$/u',

...
<head>
    <meta charset="UTF-8">
    <title>ISP | Student Isp Payment</title>
</head>
<style>
    .btn_verify {
        font-size: 15px;
            ...
            <table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px;margin-right:20px;">
                ...
                <tr>
                    <td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">
                        {{strtoupper($details->username) }} your Isp payment link <a href="{{route('web_stripe_form',$details->id,$details->amount)}}">Pay now</a></td>
                </tr>
                <tr>
                    <td height="10"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td align="center" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575;padding: 0px 51px;line-height: 0.8rem; font-weight: 300;">
                        ...
                        <p>Payment Amount : <b>${{$details->amount}}</b></p>
                    </td>
                </tr>
                </tbody>
            </table>

    ...
    <div class="col-md-9 col-sm-9 col-xs-12">
        <div class="main_bg">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="student_2">
                        <a href="coordinators_list.html"><i class="fa-solid fa-plus"></i>New
                            Coordinators</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table_content">
                            <div class="table-reponsive">
                                <table id="example" class="table" style="width:100%">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><img src="images/table_4.jpg" class="img-fluid" alt="">
                                            <a href="coordinators_list.html">Martin Garix</a>
                                        </td>
                                        <td><a
                                                href="coordinators_list.html">martingarix7878@gmail.com</a>
                                        </td>
                                        <td class="edu"><a
                                                href="javascript:void(0)">315-369-5835</a></td>
                                        <td>
                                            <ul class="me_ico">
                                                <li><a href="coordinators_list.html"> <i

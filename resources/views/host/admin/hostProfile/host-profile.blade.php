...
@section('content')
    ...
    <div class="col-md-9 col-sm-9 col-xs-9">
        <div class="main_bg">
            <h4 style="color: #000">Host Application Detail</h4> <br>
            <div class="row m-t-30">
                <div class="col-md-12">
                    ...
                    <div class="table-responsive m-b-40">
                        ...
                        <form action="{{ route('hd_update_host_application',[$hostBasic->user_id]) }}" id="hd_update_host_application" method="POST"
                        ...
                        <form action="{{ route('hd_update_partner_application',[$hostPartner->user_id]) }}" id="hd_update_partner_application" 
                        ...
                        <form action="{{ route('hd_update_adult_application',[$hostPartner->user_id]) }}" id="hd_update_adult_application" 
                              method="POST" enctype="multipart/form-data">
                            @csrf
                            <table class="table table-bordered table-data3">
                        ...
                        <form action="{{ route('hd_update_child_application',[$hostPartner->user_id]) }}" id="hd_update_child_application" 
                              method="POST" enctype="multipart/form-data">
                            @csrf
                            <table class="table table-bordered table-data3">
                        ...
                        <form action="{{ route('hd_update_pets_application',[$hostPartner->user_id]) }}" id="hd_update_pets_application" 
                              method="POST" enctype="multipart/form-data">
                            @csrf
                            <table class="table table-bordered table-data3">
                        ...
                        <form action="{{ route('hd_update_house_school_student_application',[$hostPartner->user_id]) }}" id="hd_update_house_school_student_application" 
                              method="POST" enctype="multipart/form-data">
                            @csrf
                            <table class="table table-bordered table-data3">
                        ...
                        <form action="{{ route('hd_update_personal_details_application',[$hostPartner->user_id]) }}" id="hd_update_personal_details_application" 
                              method="POST" enctype="multipart/form-data">
                            @csrf
                            <table class="table table-bordered table-data3">
                    ...
                    <div class="haf_form_btn">
                        ...
                        <form action="{{ route('hd_update_emergency_details_application',[$hostPartner->user_id]) }}" id="hd_update_emergency_details_application" 
                          method="POST" enctype="multipart/form-data">
                        @csrf
                        <table class="table table-bordered table-data3">

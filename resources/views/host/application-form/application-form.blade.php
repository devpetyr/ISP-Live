...
<!-- header end -->
    ...
    <section class="payment-form">
        <div class="container-fluid">
            ...
            <!--<form action="{{ route('web_host_information_application') }}" method="post" enctype="multipart/form-data">-->
            <!--    @csrf-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-submit">
                                                    ...
                                                    @if(isset($hostInformation->profile_photo))
                                                    <img class="bottom_img" src="{{ asset('Host-Image/'.$hostInformation->profile_photo ) }}" >
                                                    @endif
                ...
                <form action="{{ route('web_host_partner_application') }}" method="post" enctype="multipart/form-data">
                @csrf
                         ...
                         <!--Adult details start-->
                <form action="{{ route('web_host_adult_application') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <form action="{{ route('web_host_childs_application') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <form action="{{ route('web_host_pets_house_student_school_application') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <form action="{{ route('web_host_personal_detail_application') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <form action="{{ route('web_host_emergency_contact_application') }}" method="post" enctype="multipart/form-data">
                @csrf

...
{{--    @endif--}}
    ...
    <section class="payment-form">
        <div class="container">
            <form action="{{route('new_student_application_form_submit')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-main">
                    <!--Card-box Choose Program Start-->
                    ...
                    <!--Card-box Choose Program End-->

                    <!--Card-box Student Information Start-->
                    <div class="form_style">
                        ...
                        <div class="input-flds-main">
                            ...
                            <h6 class="passport-number"><i class="fa-solid fa-passport"></i>Passport Number
                                <span>*</span></h6>*
                            <div class="input-flds">
                            ...
                            @enderror
                            <h6 class="passport-exp"><i class="fa-solid fa-calendar-days"></i>Expiration Date
                                <span>*</span></h6>
                            <div class="input-flds">
                        ...
                        <div class="permanent-adress ">
                            ...
                            <div class="input-flds before">
                                ...
                                <select class="yd-select " name="student_country" id="student_country" placeholder=""
                                        tabindex="1" data-parsley-group="block-0">
                                    <option value=""></option>
                                    <option value="Afghanistan">Afghanistan</option>
                                    <option value="Åland Islands">Åland Islands</option>
                            ...
                            <div class="input-flds">
                                <label><i class="fa-solid fa-number"></i>Zip Code<span>*</span></label>
                        ...
                        <div class="permanent-adress ">
                            ...
                            <div class="input-flds">
                                <label><i class="fa-solid fa-mobile-button"></i>Phone Number<span>*</span></label>
                            ...
                            @enderror
                            <div class="input-flds">
                                <label><i class="fa-solid fa-mobile-button"></i>WeChat <span>*</span></label>
                            ...
                            @enderror
                            <div class="input-flds">
                                <label><i class="fa-solid fa-mobile-button"></i>Line <span>*</span></label>
                            ...
                            @enderror
                            <div class="input-flds">
                                <label><i class="fa-solid fa-mobile-button"></i>WhatsApp <span>*</span></label>
                        ...
                        <div class="permanent-adress student">
                            ...
                            <div class="input-flds before">
                                <label><i class="fa-solid fa-address-card"></i>School State<span>*</span></label>
                                <select class="yd-select " required="" data-parsley-required=""
                            ...
                            <div class="input-flds">
                                <label><i class="fa-solid fa-graduation-cap"></i>Major/Field of Study</label>
                        ...
                        <div class="permanent-adress homestay">
                            ...
                            <p>
                                {{--                                Minimum contract lengths are below. Students may extend with host permission.--}}
                                Minimum contract length for Southern California students is 3 months.
                            </p>
                            <label><i class="fa-solid fa-calendar-days"></i>Length of Stay:<span>*</span></label>
                            <div class="payment-ckbx ">
                                <label>
                            ...
                            @enderror
                            <div class="input-flds">
                                <label><i class="fa-solid fa-graduation-cap"></i>Contract Start Date:
                                    <span>*</span></label>
                        ...
                        <div class="permanent-adress ">
                            <h6 class="pay-method"><i class="fa-solid fa-comment"></i>Do you accept children under 8
                        ...
                        <div class="permanent-adress ">
                            ...
                            <div class="input-flds db">
                                ...
                                <label>(80% of American households have pets. You will restrict your host family
                    ...
                    <!--Card-box Student Information End-->

                    <!--Card-box Agent Details Start-->
                    <div class="form_style">
                        <h3>Agent Details</h3>
                        ...
                        <div class="using-agent">
                            <div class="input-flds">
                                <label><i class="fa-solid fa-phone-flip"></i>Agent Phone Number (with country
                                    code)</label>
                            ...
                            <div class="input-flds">
                                <label><i class="fa-solid fa-phone-flip"></i>Agent's WeChat</label>
                            ...
                            @enderror
                            <div class="input-flds">
                                <label><i class="fa-solid fa-phone-flip"></i>Agent's Line</label>
                            ...
                            @enderror
                            <div class="input-flds">
                                <label><i class="fa-solid fa-phone-flip"></i>Agent's Whatsapp</label>
                    ...
                    <div class="form_style">
                        <div class="food-restrictions">
                            ...
                            <div class="input-flds">
                                ...
                                <textarea placeholder="Enter Text Here ..." name="describe_your_personality"
                                          required></textarea>
                            </div>
                            ...
                            @enderror
                            <div class="input-flds">
                                <label><i class="fa-solid fa-file-lines"></i>Please describe your travel
                                    experience:<span>*</span>(0)</label>
                                <textarea placeholder="Enter Text Here ..." name="describe_your_travel_experience"
                                          required></textarea>
                            </div>
                            ...
                            @enderror
                            <div class="input-flds">
                                <label><i class="fa-solid fa-file-lines"></i>Please write a greeting to your host:<span>*</span>(0)</label>
                                <textarea placeholder="Enter Text Here ..." name="write_greeting_to_host"
                                          required></textarea>
                            </div>
                    ...
                    <div class="form_style">
                        <div class="medical-info">
                            ...
                            <h6 class="pay-method"><i class="fa-solid fa-circle-question"></i>Are you in good
                                health?<span>*</span></h6>
                            <div class="payment-ckbx three">
                            ...
                            <div class="input-flds db">
                                <label><i class="fa-solid fa-file-lines"></i>If no, please explain :</label><br>
                            ...
                            <h6 class="pay-method"><i class="fa-solid fa-circle-question"></i>Do you have
                            ...
                            <div class="payment-ckbx three">
                                ...
                                <label>
                                    <input type="radio" value="no" name="do_you_have_medical_allergies">
                                    <span class="checkmark">No</span>
                                </label>
                            ...
                            <div class="input-flds db">
                                <label><i class="fa-solid fa-file-lines"></i>If yes, please explain:</label><br>
                            ...
                            <h6 class="pay-method"><i class="fa-solid fa-circle-question"></i>Do you take
                                medication?<span>*</span></h6>
                            <div class="payment-ckbx three">

                                <label>
                                    <input type="radio" value="yes" checked="checked" name="do_you_take_medication">
                                    <span class="checkmark">Yes</span>
                                </label>
                                <label>
                            ...
                            <h6 class="pay-method"><i class="fa-solid fa-circle-question"></i>
                                Have you been under the care of a psychiatrist and/or counselor in the past 5 years?
                                <span>*</span></h6>
                            <div class="payment-ckbx three">
                                ...
                                <label>
                                    <input type="radio" value="no" name="under_care_of_psychiatrist_past_five_year">
                                    <span class="checkmark">No</span>
                                </label>
                            ...
                            <div class="input-flds db">
                                <label><i class="fa-solid fa-file-lines"></i>If yes, please explain:</label><br>
                                <input type="text" name="if_yes_please_explain_reason_of_psychiatrist">
                            </div>
                            ...
                            <div class="payment-ckbx three">
                                ...
                                <label>
                                    <input type="radio" value="no" name="have_who_approved_vaccination">
                                    <span class="checkmark">No</span>
                                </label>
                            ...
                            <h6 class="pay-method"><i class="fa-solid fa-circle-question"></i>
                                Please attach a photo of your vaccine card with your completed application.</h6>
                            ...
                            <div class="input-flds db">
                                <label><i class="fa-solid fa-file-lines"></i>Vaccine Name:</label><br>
                            ...
                            <div class="input-flds db">
                                <label><i class="fa-solid fa-calendar-days"></i>Date(s) Administered:</label><br>
                    ...
                    <div class="form_style">
                        <div class="airport">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="drivers">
                                        <label><i class="fa-solid fa-plane-departure"></i>Do you need airport pickup
                                            service?</label>
                    ...
                    <!--Airport Confirmation End-->

                    <!--Payment Form Start-->
                    <div class="form_style five">
                        <div class="refundable-payment">
                            <h5>Payment Form</h5>
                            <h6 class="pay-method"><i class="fa-solid fa-circle-question"></i>Payment:<span>*</span>
                            </h6>
                            ...
                            <div class="payment-ckbx three">
                                ...
                                <label>
                                    <input type="radio" value="Check or Money Order" name="payment_method">
                            ...
                            <div class="input-flds refundable-payment">
                                <label><i class="fa-solid fa-user"></i>Student First Name<span>*</span></label><br>
                            ...
                            <div class="input-flds refundable-payment">
                                <label><i class="fa-solid fa-user"></i>Student Last Name<span>*</span></label><br>
                            ...
                            <div class="input-flds refundable-payment">
                                <label><i class="fa-solid fa-user"></i>Cardholder Address<span>*</span></label><br>
                            ...
                            <h6>I authorize International Student Placements to charge the program fees to my credit
                                card. I understand that all fees are non-refundable and that all credit card
                                transactions incur a 5% processing fee.</h6>
                            <br>

                            <h6 class="pay-method"><i class="fa-solid fa-money-bill-1"></i>Placement Fee</h6>
                            <div class="payment-ckbx three">
                            ...
                            <div class="smoke-flex">
                                <h6 class="pay-method"><i class="fa-solid fa-money-bill-1"></i>Late Fee</h6>
                            </div>
                            <div class="payment-ckbx three">
                            ...
                            <div class="smoke-flex">
                                <h6 class="pay-method"><i class="fa-solid fa-money-bill-1"></i>$100 Deposit</h6>
                            </div>
                            <div class="payment-ckbx three">
                            ...
                            <h6 class="pay-method"><i class="fa-solid fa-money-bill-1"></i>Airport Pickup Fee</h6>
                            <div class="payment-ckbx three">
                                <label>
                    ...
                    <!--International Student Placement Agreement Start-->
                    <div class="form_style">
                        <div class="refundable-payment termsconditions">
                            ...
                            <div class="agreement-conditions">
                                ...
                                <div class="payment-ckbx three">
                                    <label>
                                        <input type="checkbox" value="yes" name="payments_agreement">
                                        <span class="checkmark">
                                ...
                                <h5>Students:</h5>
                                <p>Each party warrants that it has full power and authority to enter and perform under
                                    this Agreement and that the person signing this Agreement on behalf of such party
                                    has been duly authorized and empowered to execute this Agreement. The student either
                                    fully comprehends English or has had an interpreter explain this Agreement in its
                                    entirety. In witness whereof, the parties hereto have caused this Agreement to be
                                    executed.</p>

                                <h5>Parents (students under 18):</h5>
                                <p>I acknowledge that my child is under the age of 18 years old, and that I will be held
                                    responsible for my child’s actions while they are in the ISP program. I agree to pay
                                    the full amount for all damages that my child is responsible for, regardless of
                                    whether the damages were accidental. I agree to hold ISP and my child’s host
                                    harmless and release all liability including all claims against ISP and the host
                                    family for injury, loss, damages, accident, delay or expense resulting from

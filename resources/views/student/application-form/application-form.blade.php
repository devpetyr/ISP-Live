        ...
        <div class="form-main2">
            ...
            <main class="main-newfrm">
                <article class=form-article>
                    ...
                    <form action="{{route('web_saf_submit_1')}}" id="Form-Section1" method="post"
...
{{--                        <input type="hidden" name="section" value="Form-Section1"/>--}}
                                ...
                                <div class="input-flds-main">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="input-flds">
                                                ...
                                                <input class="form1" type="text" name="first_name" value="{{$Saf_BasicInfo ? $Saf_BasicInfo->first_name : ""}}" >
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="input-flds">
                                                <label><i class="fa-solid fa-user"></i>Last
                                                    Name<span>*</span></label>
                                                <input class="form1" type="text" name="last_name" value="{{$Saf_BasicInfo ? $Saf_BasicInfo->last_name : ""}}" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="input-flds">
                                                <label><i class="fa-solid fa-calendar-days"></i>Date of Birth
                                                    <span>*</span></label><br>
                                                <input type="date" name="dob"  value="{{$Saf_BasicInfo ? $Saf_BasicInfo->dob : ""}}" >
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="input-flds">
                                                <input type="number" name="age" maxlength="3" value="{{$Saf_BasicInfo ? $Saf_BasicInfo->age : ""}}"  >
                                                @error('age')
                                                <div class="saf_msg">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="input-flds before">
                                                ...
                                                <select class="yd-select "   data-parsley-required=""
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <h6 class="passport-number"><i class="fa-solid fa-passport"></i>Passport
                                                ...
                                                <span>*</span></h6>
                                            <div class="input-flds">
                                                <input type="text" name="passport_number" maxlength="100" value="{{$Saf_BasicInfo ? $Saf_BasicInfo->passport_number : ""}}"  >
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <h6 class="passport-exp"><i class="fa-solid fa-calendar-days"></i>Expiration
                                                ...
                                                <span>*</span></h6>
                                            <div class="input-flds">
                                                <input type="date" name="passport_exp" value="{{$Saf_BasicInfo ? $Saf_BasicInfo->passport_exp : ""}}"  >
                    ...
                    <!--Section 2 Start-->
                    <form action="{{route('web_saf_submit_2_1')}}" id="Form-Section2-1" method="post">
                        @csrf
{{--                        <input type="hidden" name="section" value="Form-Section2-1"/>--}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                ...
                                                <input type="text" name="student_address" value="{{$SafStudentInfo ? $SafStudentInfo->student_address : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                ...
                                                <input type="number" name="student_address_zip_code" value="{{$SafStudentInfo ? $SafStudentInfo->student_address_zip_code : ""}}"  >
                                ...
                                <div class="permanent-adress ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-flds">
                                                ...
                                                <input type="text" name="father_name" value="{{$SafStudentInfo ? $SafStudentInfo->father_name : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                ...
                                                <input type="tel" name="father_phone" value="{{$SafStudentInfo ? $SafStudentInfo->father_phone : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                ...
                                                <input type="email" name="father_email"  value="{{$SafStudentInfo ? $SafStudentInfo->father_email : ""}}"  >
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-flds">
                                                <label><i class="fa-solid fa-phone"></i>Name<span>*</span></label>
                                                <input type="text" name="mother_name"  value="{{$SafStudentInfo ? $SafStudentInfo->mother_name : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                <label><i class="fa-solid fa-phone"></i>Phone<span>*</span></label>
                                                <input type="tel" name="mother_phone"  value="{{$SafStudentInfo ? $SafStudentInfo->mother_phone : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                <label><i class="fa-solid fa-email"></i>Email<span>*</span></label>
                                                <input type="email" name="mother_email" value="{{$SafStudentInfo ? $SafStudentInfo->mother_email : ""}}"  >
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                ...
                                                <input type="text" name="student_contact_phone_number" value="{{$SafStudentInfo ? $SafStudentInfo->student_contact_phone_number : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            ...
                                            <div class="input-flds">
                                                ...
                                                <input type="text" name="student_contact_email" value="{{$SafStudentInfo ? $SafStudentInfo->student_contact_email : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                <label><i class="fa-solid fa-mobile-button"></i>WeChat
                                                    <span>*</span></label>
                                                <input type="text" name="student_contact_wechat_number" value="{{$SafStudentInfo ? $SafStudentInfo->student_contact_wechat_number : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                <label><i class="fa-solid fa-mobile-button"></i>Line
                                                    <span>*</span></label>
                                                <input type="text" name="student_contact_line_number" value="{{$SafStudentInfo ? $SafStudentInfo->student_contact_line_number : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                <label><i class="fa-solid fa-mobile-button"></i>WhatsApp
                                                    <span>*</span></label>
                                                <input type="text" name="student_contact_whatsApp_number" value="{{$SafStudentInfo ? $SafStudentInfo->student_contact_whatsApp_number : ""}}"  >
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                ...
                                                <input type="text" name="emergency_contact_name" value="{{$SafStudentInfo ? $SafStudentInfo->emergency_contact_name : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                ...
                                                <input type="text" name="emergency_contact_relation" value="{{$SafStudentInfo ? $SafStudentInfo->emergency_contact_relation : ""}}"  >
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                <label><i class="fa-solid fa-envelope"></i>Email<span>*</span></label>
                                                <input type="text" name="emergency_contact_email" value="{{$SafStudentInfo ? $SafStudentInfo->emergency_contact_email : ""}}" >
                    ...
                    <form action="{{route('web_saf_submit_2_2')}}" id="Form-Section2-2" method="post">
                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds">
                                                ...
                                                <input type="text" name="school_city" value="{{$SafStudentInfo ? $SafStudentInfo->school_city : ""}}" >
                                                @error('school_city')
                                                <div class="saf_msg">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <div class="input-flds before">
                                                ...
                                                <select class="yd-select " name="school_state" id="school_state" tabindex="1" data-parsley-group="block-0">
                                                        <option value="{{$SafStudentInfo && $SafStudentInfo->school_state ? $SafStudentInfo->school_state : ""}}">{{$SafStudentInfo && $SafStudentInfo->getState->name ? $SafStudentInfo->getState->name : "Please select state"}}</option>
                                        ...
                                        <div class="permanent-adress ">
                                            ...
                                            <div class="input-flds">
                                                ...
                                                <textarea placeholder="Enter Text Here ..." name="food_restrictions"
                                                          >{{$SafStudentInfo ? $SafStudentInfo->food_restrictions : ""}}</textarea>
                    ...
                    <form action="{{route('web_saf_submit_3')}}" id="Form-Section3" method="post">
                    @csrf
                    <!--Section 3 Start-->
                        <section class="my-newfrm ">
                            <div class="form_style main-cardbox">
                    ...
                    <form action="{{route('web_saf_submit_4')}}" id="Form-Section4" method="post">
                    @csrf
                    <!--Section 4 Start-->
                        <section class="my-newfrm">
                            <div class="form_style main-cardbox">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-flds">
                                                ...
                                                <textarea placeholder="Enter Text Here ..." name="specific_needs"
                                                          >{{$SafOtherInfo ? $SafOtherInfo->specific_needs : ""}}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-flds">
                                                ...
                                                <textarea placeholder="Enter Text Here ..."
                                                          ...
                                                          >{{$SafOtherInfo ? $SafOtherInfo->hobbies_and_interest : ""}}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-flds">
                                                ...
                                                <textarea placeholder="Enter Text Here ..."
                                                          ...
                                                          >{{$SafOtherInfo ? $SafOtherInfo->describe_your_personality : ""}}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-flds">
                                                ...
                                                <textarea placeholder="Enter Text Here ..."
                                                          ...
                                                          >{{$SafOtherInfo ? $SafOtherInfo->describe_your_family : ""}}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-flds">
                                                ...
                                                <textarea placeholder="Enter Text Here ..."
                                                          ...
                                                          >{{$SafOtherInfo ? $SafOtherInfo->describe_your_travel_experience : ""}}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-flds">
                                                ...
                                                <textarea placeholder="Enter Text Here ..."
                                                          ...
                                                          >{{$SafOtherInfo ? $SafOtherInfo->write_greeting_to_host : ""}}</textarea>
                    ...
                    <form action="{{route('web_saf_submit_5')}}" id="Form-Section5" method="post" enctype="multipart/form-data">
                    @csrf
                    <!--Section 5 Start-->
                        <section class="my-newfrm">
                            <div class="form_style  main-cardbox">
                    ...
                    <form action="{{route('web_saf_submit_6')}}" id="Form-Section6" method="post">
                    @csrf
                    <!--Section 6 Start-->
                        <section class="my-newfrm">
                            <div class="form_style  main-cardbox">
                    ...
                    <form action="{{route('web_saf_submit_7')}}" id="Form-Section7" method="post">
                    @csrf
                    <!--Section 7 Start-->
                        <section class="my-newfrm">
                            <div class="form_style  main-cardbox">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-flds refundable-payment">
                                                ...
                                                <input type="text" name="card_holder_student_last_name"
                                                       value="{{$Saf_BasicInfo ? $Saf_BasicInfo->last_name : ""}}" >
...
<!--{{--                                        </h6>--}}-->
                    ...
                    <!--Section 8 Start-->
                    <form action="{{route('web_saf_submit_8_1_1')}}" id="Form-Section8-1-1" method="post">
                    @csrf
                    ...
                    <form action="{{route('web_saf_submit_8_1_2')}}" id="Form-Section8-1-2" method="post">
                    @csrf
                    <!--Section 8 First Half Start-->
                        <section class="my-newfrm">
                            <div class="form_style  main-cardbox">
                    ...
                    <form action="{{route('web_saf_submit_8_2')}}" id="Form-Section8-2" method="post">
                    @csrf

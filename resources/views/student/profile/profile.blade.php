...
@section('content')
    ...
    <div class="col-md-9 col-sm-9 col-xs-9">
        <div class="main_bg">
            <h4 style="color: #000">Application Details</h4> <br>
            <div class="row m-t-30">
                ...
                <div class="table-responsive m-b-40">
                    <form action="{{ route('sd_update_submit_1') }}" id="Form-Section1" method="POST"
                    ...
                    <form action="{{ route('sd_update_submit_2_1') }}" id="Form-Section2-1" method="POST"
                          enctype="multipart/form-data">
                        @csrf
                    ...
                    <form action="{{ route('sd_update_submit_2_2') }}" id="Form-Section2-2" method="POST"
                          enctype="multipart/form-data">
                        @csrf
                    ...
                    <form action="{{ route('sd_update_submit_3') }}" id="Form-Section3" method="POST"
                          enctype="multipart/form-data">
                        @csrf
                    ...
                    <form action="{{ route('sd_update_submit_4') }}" id="Form-Section4" method="POST"
                          enctype="multipart/form-data">
                        @csrf
                    ...
                    <form action="{{ route('sd_update_submit_5') }}" id="Form-Section5" method="POST"
                          enctype="multipart/form-data">
                        @csrf
                    ...
                    <form action="{{ route('sd_update_submit_6') }}" id="Form-Section6" method="POST"
                          enctype="multipart/form-data">
                        @csrf
                    ...
                    <form action="{{ route('sd_update_submit_7') }}" id="Form-Section7" method="POST"
                          enctype="multipart/form-data">
                        @csrf

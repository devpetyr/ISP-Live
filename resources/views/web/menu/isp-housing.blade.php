...
@section('page_title','ISP - Isp-Housing')
@section('content')
    <!-- Isp housing start -->
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="{{asset('web/images/iSP-Housing-Programs.back-img.jpg')}}" class="img-fluid" alt="...">
              ...
              <div class="row">
                ...
                <div class="banner-content">
                  <div class="banner_text wow fadeInLeft" data-wow-duration="2s">
                    <h1 class="wow zoomIn">Isp-Housing-Programs </h1>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="isp-card">
              ...
              <img src="{{asset('web/images/iSP-Housing-Programs.img-1.jpg')}}">
            </div>
          ...
          <div class="col-md-4">
            <div class="isp-card">
              <div class="isp-card-img">
                <img src="{{asset('web/images/iSP-Housing-Programs.img-2.jpg')}}">
            </div>
            <div class="card-content">
              <a href="javascript:void(0)">Lorem Ipsum</a>
              <a href="javascript:void(0)">Lorem Ipsum</a>
          ...
          <div class="col-md-4">
            <div class="isp-card">
              <div class="isp-card-img">
                <img src="{{asset('web/images/iSP-Housing-Programs.img-3.jpg')}}">
            </div>
            <div class="card-content">
              <a href="javascript:void(0)">Lorem Ipsum</a>
              <a href="javascript:void(0)">Lorem Ipsum</a>
          ...
          <div class="col-md-4">
            <div class="isp-card">
              <div class="isp-card-img">
                <img src="{{asset('web/images/iSP-Housing-Programs.img-4.jpg')}}">
            </div>
            <div class="card-content">
              <a href="javascript:void(0)">Lorem Ipsum</a>
              <a href="javascript:void(0)">Lorem Ipsum</a>

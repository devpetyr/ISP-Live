...
@section('page_title','ISP - High School Program')
@section('content')
        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{asset('web/images/high-bg-school.png')}}" class="img-fluid" alt="...">
                                ...
                                <div class="col-xs-12 col-sm-8 col-md-8 ">
                                    <div class="banner-content">
                                        <div class="banner_text wow fadeInLeft" data-wow-duration="2s">
                                            <h1 class="wow zoomIn">High School Program</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div>
        <div class="blog_slid">
          <div class="row">
            ...
            <img src="{{asset('web/images/heigh-school-img-sli.png')}}" class="img-fluid">
            </div>            
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-sm-10 col-md-12 centerCol">
                    <div class="link-box">
                        <a href="#">For more information about our high school programs,</br>
                            please email highschool@isphomestays.com </a>
                    </div>
                </div>
            </div>
        </div>
